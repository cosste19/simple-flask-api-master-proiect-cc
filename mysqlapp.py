...
#     connection = pymysql.connect(host='35.205.11.169',
#                                  port=33061,
#                                  user='test',
#                                  password='parola2024',
#                                  db='sakila',
...
# Route to return all store in the catalog
...
def page_not_found(e):
    return "<h1>404 - Not Found</h1><p>You've stumbled into Fight Club's 404 Error Room. First rule of browsing: don't talk about the missing page!</p><p>DO NOT TALK ABOUT IT</p>", 404
